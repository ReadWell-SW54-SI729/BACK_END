...
@Tag(name="Equipment", description="Books Management Endpoints")
public class BookController {
    ...
    @PostMapping
    public ResponseEntity<BookResource> createEquipment(@RequestBody CreateBookResource resource) {
    ...
    public ResponseEntity<BookResource> getEquipmentById(@PathVariable Long bookId) {
    ...
    public ResponseEntity<BookResource> getEquipmentById(@PathVariable String name) {
    ...
    @GetMapping
    public ResponseEntity<List<BookResource>> getAllEquipments(){
